...
/**
 * Created by chenshanzhao on 2017/1/23.
 */
...
//            email.setSmtpPort(465);
   ...
   /* public static void main(String[] args) {
        ...
        mail.setSender("chenshanzhao123@163.com");
        mail.setReceiver("137088132@qq.com"); // 接收人
        mail.setUsername("chenshanzhao123@163.com"); // 登录账号,一般都是和邮箱名一样吧
        mail.setPassword("chen123456"); // 发件人邮箱的登录密码
